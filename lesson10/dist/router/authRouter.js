...
router.post('/login', (0, celebrate_1.celebrate)(validators_1.authValidator.login), middlewares_1.userMiddleware.checkIsUserExist, authController_1.authController.login);
